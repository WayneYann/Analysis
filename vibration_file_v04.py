...
O = Data.Zfrequency[Data.index.isin(idx100) & (Data.Adsorbate=='O')]
OH = Data.Zfrequency[Data.index.isin(idx100) & (Data.Adsorbate=='OH')]
N = Data.Zfrequency[Data.index.isin(idx100) & (Data.Adsorbate=='N')]
NH = Data.Zfrequency[Data.index.isin(idx100) & (Data.Adsorbate=='NH')]
NH2 = Data.Zfrequency[Data.index.isin(idx100) & (Data.Adsorbate=='NHH')]
C = Data.Zfrequency[Data.index.isin(idx100) & (Data.Adsorbate=='C')]
CH = Data.Zfrequency[Data.index.isin(idx100) & (Data.Adsorbate=='CH')]
CH2 = Data.Zfrequency[Data.index.isin(idx100) & (Data.Adsorbate=='CHH')]
CH3 = Data.Zfrequency[Data.index.isin(idx100) & (Data.Adsorbate=='CHHH')]
CH2CH3 = Data.Zfrequency[Data.index.isin(idx100) & (Data.Adsorbate=='CCHHHHH')]
C2H4 = Data.Zfrequency[Data.index.isin(idx100) & (Data.Adsorbate=='CCHHHH')]

O111 = Data.Zfrequency[(Data.Surface == 111) & Data.Substrate.isin(Metals) & (Data.NN ==1) & (Data.Adsorbate=='O')]
OH111 = Data.Zfrequency[(Data.Surface == 111) & Data.Substrate.isin(Metals) & (Data.NN ==1) & (Data.Adsorbate=='OH')]
O110 = Data.Zfrequency[(Data.Surface == 110) & Data.Substrate.isin(Metals) & (Data.NN ==1) & (Data.Adsorbate=='O')]
OH110 = Data.Zfrequency[(Data.Surface == 110) & Data.Substrate.isin(Metals) & (Data.NN ==1) & (Data.Adsorbate=='OH')]

Metals2 = ['Au','Ag','Cu','Pt','Rh','Ir','Pd']
CH3110 = Data.Zfrequency[(Data.Surface == 110) & Data.Substrate.isin(Metals2) & (Data.NN ==1) & (Data.Adsorbate=='CHHH')]
CH2CH3110 = Data.Zfrequency[(Data.Surface == 110) & Data.Substrate.isin(Metals2) & (Data.NN ==1) & (Data.Adsorbate=='CCHHHHH')]

CH3111 = Data.Zfrequency[(Data.Surface == 111) & Data.Substrate.isin(Metals) & (Data.NN ==1) & (Data.Adsorbate=='CHHH')]
CH2CH3111 = Data.Zfrequency[(Data.Surface == 111) & Data.Substrate.isin(Metals) & (Data.NN ==1) & (Data.Adsorbate=='CCHHHHH')]
...
OAll = Data.Zfrequency[(Data.Adsorbate=='O')& Data.Substrate.isin(Metals)]
NAll = Data.Zfrequency[(Data.Adsorbate=='N')& Data.Substrate.isin(Metals)]
pNO = np.polyfit(NAll**2, OAll**2, 1)
Narray = np.linspace(np.min(NAll),np.max(NAll),50,endpoint=True)
Ofit = (pNO[0]*Narray**2+pNO[1])**0.5
plt.plot(NAll, OAll,'go')
plt.xlabel(r'$\mathbf{\nu}_{\perp,N}$ [$cm^{-1}$]',size=32)
plt.ylabel(r'$\mathbf{\nu}_{\perp,O}$ [$cm^{-1}$]',size=32)
plt.plot(Narray,Ofit,'-g')
plt.legend([r'$\mathbf{\nu}_{\perp,O}$=(%.2f$\mathbf{\nu}^2_{\perp,N}$ + %.0f $cm^{-2})^{1/2}$' %(pNO[0],pNO[1])]
,loc=2,prop={'size':24},frameon=False)
plt.xticks(np.arange(200, 1001, 200))
plt.yticks(np.arange(200, 901, 200))
plt.xticks(size=28)
plt.yticks(size=28)
plt.xlim([150,1050])
plt.ylim([150,850])
...
plt.plot(Narray, NHfit,'-g')
plt.plot(Narray, NH2fit,'-b')
plt.legend([r'$\mathbf{\nu}_{\perp,NH}$=$(%.2f\mathbf{\nu}^{2}_{\perp,N} + %.0f\: cm^{-2})^{1/2}$' %(pNH[0],pNH[1])
,r'$\mathbf{\nu}_{\perp,NH_{2}}$=$(%.2f\mathbf{\nu}^{2}_{\perp,N} + %.0f\: cm^{-2})^{1/2}$' %(pNH2[0],pNH2[1])]
...
pCH = np.polyfit(C**2, CH**2, 1)
Carray = np.linspace(np.min(C),np.max(C),50,endpoint=True)
CHfit = (pCH[0]*Carray**2+pCH[1])**0.5
pCH2 = np.polyfit(C**2, CH2**2, 1)
CH2fit = (pCH2[0]*Carray**2+pCH2[1])**0.5
pCH3 = np.polyfit(C**2, CH3**2, 1)
CH3fit = (pCH3[0]*Carray**2+pCH3[1])**0.5
plt.plot(C, CH,'g^')
plt.plot(C, CH2,'bo')
plt.plot(C, CH3,'rs')
plt.xlabel(r'$\mathbf{\nu}_{\perp,C}$ [$cm^{-1}$]',size=16)
plt.ylabel(r'$\mathbf{\nu}_{\perp,CHx}$ [$cm^{-1}$]',size=16)
plt.plot(Carray, CHfit,'-g')
plt.plot(Carray, CH2fit,'-b')
plt.plot(Carray, CH3fit,'-r')
plt.legend([r'$\mathbf{\nu}_{\perp,CH}$=(%.2f$\mathbf{\nu}^2_{\perp,C}$ + %.0f $cm^{-2})^{1/2}$' %(pCH[0],pCH[1])
,r'$\mathbf{\nu}_{\perp,CH_{2}}$=(%.2f$\mathbf{\nu}^2_{\perp,C}$ + %.0f $cm^{-2})^{1/2}$' %(pCH2[0],pCH2[1])
,r'$\mathbf{\nu}_{\perp,CH_{3}}$=(%.2f$\mathbf{\nu}^2_{\perp,C}$ + %.0f $cm^{-2})^{1/2}$' %(pCH3[0],pCH3[1])]
,loc=2,prop={'size':12},frameon=False)
plt.xticks(size=14)
plt.yticks(size=14)
plt.xlim([530,1020])
...
ax3 = plt.subplot(G[1,:])
pOH = np.polyfit(O**2, OH**2, 1)
Oarray = np.linspace(np.min(O),np.max(O),50,endpoint=True)
OHfit = (pOH[0]*Oarray**2+pOH[1])**0.5
pOH111 = np.polyfit(O111**2, OH111**2, 1)
O111array = np.linspace(np.min(O111),np.max(O111),50,endpoint=True)
OH111fit = (pOH111[0]*Oarray**2+pOH111[1])**0.5
pOH110 = np.polyfit(O110**2, OH110**2, 1)
O110array = np.linspace(np.min(O110),np.max(O110),50,endpoint=True)
OH110fit = (pOH110[0]*Oarray**2+pOH110[1])**0.5
plt.plot(O, OH,'g^')
plt.plot(O111, OH111,'bo')
plt.plot(O110, OH110,'rs')
plt.xlabel(r'$\mathbf{\nu}_{\perp,O}$ [$cm^{-1}$]',size=32)
plt.ylabel(r'$\mathbf{\nu}_{\perp,OH}$ [$cm^{-1}$]',size=32)
plt.plot(Oarray, OHfit,'g-')
plt.plot(O111array, OH111fit,'b-')
plt.plot(O110array, OH110fit,'r-')
plt.legend([r'$\mathbf{\nu}_{\perp,OH-100}$=(%.2f$\mathbf{\nu}^2_{\perp,O-100}$ + %.0f $cm^{-2})^{1/2}$' %(pOH[0],pOH[1])
,r'$\mathbf{\nu}_{\perp,OH-111}$=(%.2f$\mathbf{\nu}^2_{\perp,O-111}$ + %.0f $cm^{-2})^{1/2}$' %(pOH111[0],pOH111[1])
,r'$\mathbf{\nu}_{\perp,OH-110}$=(%.2f$\mathbf{\nu}^2_{\perp,O-110}$ + %.0f $cm^{-2})^{1/2}$' %(pOH110[0],pOH110[1])]
...
pCH2CH3 = np.polyfit(CH3**2, CH2CH3**2, 1)
pCH2CH3111 = np.polyfit(CH3111**2, CH2CH3111**2, 1)
pCH2CH3110 = np.polyfit(CH3110**2, CH2CH3110**2, 1)
CH3array = np.linspace(np.min(CH3),np.max(CH3),50,endpoint=True)
CH2CH3fit = (pCH2CH3[0]*CH3array**2+pCH2CH3[1])**0.5
CH3111array = np.linspace(np.min(CH3111),np.max(CH3111),50,endpoint=True)
CH2CH3111fit = (pCH2CH3111[0]*CH3111array**2+pCH2CH3111[1])**0.5
CH3110array = np.linspace(np.min(CH3110),np.max(CH3110),50,endpoint=True)
CH2CH3110fit = (pCH2CH3110[0]*CH3110array**2+pCH2CH3110[1])**0.5
...
plt.plot(CH3array,CH2CH3fit,'-g')
plt.plot(CH3111array,CH2CH3111fit,'-b')
plt.plot(CH3110array,CH2CH3110fit,'-r')
plt.legend([r'$\mathbf{\nu}_{\perp,CH_{2}CH_{3}-100}$=(%.2f$\mathbf{\nu}^2_{\perp,CH_{3}-100}$ + %.0f $cm^{-2})^{1/2}$' %(pCH2CH3[0],pCH2CH3[1])
,r'$\mathbf{\nu}_{\perp,CH_{2}CH_{3}-111}$=(%.2f$\mathbf{\nu}^2_{\perp,CH_{3}-111}$ + %.0f $cm^{-2})^{1/2}$' %(pCH2CH3111[0],pCH2CH3111[1])
,r'$\mathbf{\nu}_{\perp,CH_{2}CH_{3}-110}$=(%.2f$\mathbf{\nu}^2_{\perp,CH_{3}-110}$ + %.0f $cm^{-2})^{1/2}$' %(pCH2CH3110[0],pCH2CH3110[1])]
,loc=2,prop={'size':24},frameon=False)
plt.xticks(size=28)
plt.yticks(size=28)
plt.xlim([350,520])
...
plt.xlabel(r'$\mathbf{\Delta}E_{ads,CHx}$ [$eV$]',size=32)
...
OHollow = Data.Zfrequency[Data.Surface.isin([111,100]) & Data.NN.isin([3,2,4]) & Data.Substrate.isin(Metals) & (Data.Adsorbate=='O')]
O2 = Data.Zfrequency[Data.Surface.isin([111,100]) & (Data.NN ==2) & (Data.NN2 ==4) & Data.Substrate.isin(Metals) & (Data.Adsorbate=='OO')]
O2Rotation = Data.Rotation[Data.Surface.isin([111,100]) & (Data.NN ==2) & (Data.NN2 ==4) & Data.Substrate.isin(Metals) & (Data.Adsorbate=='OO')]
O2Stretch = Data.High_Frequency[Data.Surface.isin([111,100]) & (Data.NN ==2) & (Data.NN2 ==4) & Data.Substrate.isin(Metals) & (Data.Adsorbate=='OO')]
...
#plt.figure(figsize=(15,10.5))
plt.figure(12,figsize=(10,15))
ax1 = plt.subplot(2,1,2)
pO2 = np.polyfit(OHollow**2, O2**2, 1)
Oarray = np.linspace(np.min(OHollow),np.max(OHollow),50,endpoint=True)
O2fit = (pO2[0]*Oarray**2+pO2[1])**0.5
pO2Rotation = np.polyfit(OHollow**2, O2Rotation**2, 1)
O2Rotationfit = (pO2Rotation[0]*Oarray**2+pO2Rotation[1])**0.5
pO2Stretch = np.polyfit(OHollow**2, O2Stretch**2, 1)
O2Stretchfit = (pO2Stretch[0]*Oarray**2+pO2Stretch[1])**0.5
...
plt.plot(Oarray,O2fit,'b-')
plt.plot(Oarray,O2Rotationfit,'g-')
plt.plot(Oarray,O2Stretchfit,'r-')
plt.legend([r'$\mathbf{\nu}_{O_{2},\perp}$=(%.2f$\mathbf{\nu}^2_{\perp,O}$ + %.0f $cm^{-2})^{1/2}$' %(pO2[0],pO2[1])
,r'$\mathbf{\delta}_{O_{2},\perp}$=(%.2f$\mathbf{\nu}^2_{\perp,O}$ + %.0f $cm^{-2})^{1/2}$' %(pO2Rotation[0],pO2Rotation[1])
,r'$\mathbf{\nu}_{O_{2},O-O}$=(%.2f$\mathbf{\nu}^2_{\perp,O}$ + %.0f $cm^{-2})^{1/2}$' %(pO2Stretch[0],pO2Stretch[1])]
...
pO2 = np.polyfit((vMO[idx])**2, (vMO2[idx])**2, 1)
Oarray = np.linspace(np.min(OHollow),np.max(OHollow),50,endpoint=True)
O2fit = (pO2[0]*Oarray**2+pO2[1])**0.5
idx = np.isfinite(vMO) & np.isfinite(vOOsite2)
pO2Rotation = np.polyfit(vMO[idx]**2, vOOsite2[idx]**2, 1)
O2Rotationfit = (pO2Rotation[0]*Oarray**2+pO2Rotation[1])**0.5
idx = np.isfinite(vMO) & np.isfinite(vOOsite1)
pO2Stretch = np.polyfit(vMO[idx]**2, vOOsite1[idx]**2, 1)
O2Stretchfit = (pO2Stretch[0]*Oarray**2+pO2Stretch[1])**0.5
...
Data = pd.read_csv(vibration_file,sep=',',header=0)
idx1 = np.isfinite(Data['v(M-O)']) & np.isfinite(Data['v(M-H)'])
p = np.polyfit((Data['v(M-O)'][idx1])**2,(Data['v(M-H)'][idx1])**2, 1)
Oarray = np.linspace(np.min(Data['v(M-O)']),np.max(Data['v(M-O)']),50,endpoint=True)
Hfit = (p[0]*Oarray**2+p[1])**0.5
m1 = p[0]
b1=p[1]
idx2 = np.isfinite(Data['v(M-O)']) & np.isfinite(Data['v(M-N)'])
p = np.polyfit((Data['v(M-O)'][idx2])**2,(Data['v(M-N)'][idx2])**2, 1) 
Nfit = (p[0]*Oarray**2+p[1])**0.5
m2 = p[0]
b2=p[1]
idx3 = np.isfinite(Data['v(M-O)']) & np.isfinite(Data['parallel (M-H)'])
p = np.polyfit((Data['v(M-O)'][idx3])**2,(Data['parallel (M-H)'][idx3])**2, 1) 
Hparafit = (p[0]*Oarray**2+p[1])**0.5
m3 = p[0]
b3=p[1]
mat.rcParams['mathtext.default'] = 'regular'
mat.rcParams['legend.numpoints'] = 1
...
plt.figure(14)
plt.figure(figsize=(20,10))
plt.plot(Data['v(M-O)'], Data['v(M-H)'],'rs')
plt.plot(Data['v(M-O)'], Data['parallel (M-H)'],'bo')
plt.plot(Data['v(M-O)'], Data['v(M-N)'],'^g')
plt.plot(Oarray,Hfit,'-r')
plt.plot(Oarray,Hparafit,'-b')
plt.plot(Oarray,Nfit,'-g')
plt.xlabel(r'$\mathbf{\nu}_{\perp,O}$ [$cm^{-1}$]',size=32)
plt.ylabel(r'$\mathbf{\nu}_{\perp/\parallel,N/H}$ [$cm^{-1}$]',size=32)
plt.legend([r'$\mathbf{\nu}_{\perp,H}$=$(%s\mathbf{\nu}^2_{\perp,O} + %.0f \:cm^{-2})^{1/2}$' %(round(m1,2),b1)
,r'$\mathbf{\nu}_{\parallel,H}$=$(%s\mathbf{\nu}^2_{\perp,O} + %.0f \:cm^{-2})^{1/2}$' %(round(m3,2),b3)
,r'$\mathbf{\nu}_{\perp,N}$=$(\:%s\mathbf{\nu}^2_{\perp,O} + %.0f \:cm^{-2})^{1/2}$' %(round(m2,2),b2)]
...
vOO = np.concatenate((Data['v(M-O)'][idx1],Data['v(M-O)'][idx3],Data['v(M-O)'][idx2]))
vO2N = np.concatenate((Data['v(M-H)'][idx1],Data['parallel (M-H)'][idx3],Data['v(M-N)'][idx2]))
...
vN = Data['v(M-N)'][idx2]
vO = Data['v(M-O)'][idx2]
Narray = np.linspace(np.min(vN),np.max(vN),50,endpoint=True)
p = np.polyfit(vN**2,vO**2, 1) 
Ofit = (p[0]*Narray**2+p[1])**0.5
m2 = p[0]
b2=p[1]
...
plt.xlabel(r'$\mathbf{\nu}_{\perp,N}$ [$cm^{-1}$]',size=32)
plt.ylabel(r'$\mathbf{\nu}_{\perp,O}$ [$cm^{-1}$]',size=32)
plt.legend([r'$\mathbf{\nu}_{\perp,N}$=$(\:%s\mathbf{\nu}^2_{\perp,O} - %.0f \:cm^{-2})^{1/2}$' %(round(m2,2),abs(b2))]
,loc=2,prop={'size':28},frameon=False)
plt.xticks(size=28)
plt.yticks(size=28)
plt.xlim([320,560])
plt.ylim([240,640])
plt.xticks(np.arange(350, 561, 50))
plt.yticks(np.arange(250, 601, 50))
plt.gcf().subplots_adjust(bottom=0.2)
plt.gcf().subplots_adjust(left=0.12)
texts = []
M3 = Data.Surface[idx2]
for x, y, s in zip(vN, vO, M3):
    texts.append(plt.text(x, y, s, bbox={'pad':0, 'alpha':0}, size=28, fontweight='bold',style='normal',name ='Calibri'))
adjustText.adjust_text(texts,autoalign=True,only_move={'points':'y','text':'y'}, 
        arrowprops=dict(arrowstyle="-", color='k', lw=2))
plt.show()
...
KcoPt = np.exp(-delGCOPt/(kB*Temp/JeV))
KcoAg = np.exp(-delGCOAg/(kB*Temp/JeV))
KcoPtAg = np.exp(-delGCOPtAg/(kB*Temp/JeV))
KoPt = np.exp(-delGOPt/(kB*Temp/JeV))
KoAg = np.exp(-delGOAg/(kB*Temp/JeV))
KoPtAg = np.exp(-delGOPtAg/(kB*Temp/JeV))
...
Oarray = np.linspace(np.min(EO),np.max(EO),50,endpoint=True)
COarray = np.linspace(np.min(ECO),np.max(ECO),50,endpoint=True)
Ofit = mO*Oarray+bO
COfit = mCO*COarray+bCO
plt.plot(EO,GO,'bo')
plt.plot(ECO,GCO,'g^')
plt.xlabel(r'$\mathbf{\Delta}E_{ads}$ [eV]',size=32)
plt.ylabel(r'G$_{vib}$ [eV]',size=32)
plt.plot(Oarray,Ofit,'-b')
plt.plot(COarray,COfit,'-g')
plt.legend([r'G$_{vib,O}$=%.2f$\mathbf{\Delta}E_{ads}$ + %.2f $eV$' %(mO,bO)
,r'G$_{vib,CO}$=%.2f$\mathbf{\Delta}E_{ads}$ - %.2f $eV$' %(mCO,abs(bCO))]
,loc=1,prop={'size':24},frameon=False)
#plt.xticks(np.arange(200, 1001, 200))
#plt.yticks(np.arange(200, 901, 200))
plt.xticks(size=28)
...
plt.gcf().subplots_adjust(bottom=0.15)
plt.gcf().subplots_adjust(left=0.15)
M2 = np.concatenate((np.array(MetalLabels),np.array(MetalLabels)[idx2]))
E = np.concatenate((EO,ECO[idx2]))
G = np.concatenate((GO,GCO[idx2]))
texts = []
for x, y, s in zip(E, G, M2):
    texts.append(plt.text(x, y, s, bbox={'pad':0, 'alpha':0}, size=24, fontweight='bold',style='normal',name ='Calibri'))
adjustText.adjust_text(texts,autoalign=True,only_move={'points':'y','text':'y'})
plt.show() 
...
def thetaCO(EadsO, EadsCO):
    ...
    Kco = np.exp(-1*delGCO/(kB*Temp/JeV))
    delGO = EadsO-O2gibbs/2 +mO*EadsO+bO
    Ko = np.exp(-1*delGO/(kB*Temp/JeV))
...
def theta2CO(EadsO, EadsCO):
    delGCO = EadsCO-COgibbs + GCO[PdI]
    Kco = np.exp(-1*delGCO/(kB*Temp/JeV))
...
for i in xrange(len(xx)):
    for j in xrange(len(yy)):
        zz[j, i] = theta2CO(xx[i], yy[j]) - thetaCO(xx[i], yy[j])
pylab.figure(18)
pylab.pcolor(xx, yy, zz,cmap='jet_r')
pylab.plot(EO,ECO,'ko')
pylab.plot(EO[7],ECO[7],'wo')
pylab.ylabel('CO Eads [eV]')
pylab.xlabel('O Eads [eV]')
pylab.colorbar()
...
texts = []
for x, y, s in zip(EO+0.01, ECO+0.02, MetalLabels):
    texts.append(pylab.text(x, y, s, bbox={'pad':0, 'alpha':0}, size=24, fontweight='bold',style='normal',name ='Calibri',color='k'))

ENi = EO[7]; ECNi = ECO[7]; MNi = MetalLabels[7]
texts.append(pylab.text(ENi+0.01, ECNi+0.02, MNi, bbox={'pad':0, 'alpha':0}, size=24, fontweight='bold',style='normal',name ='Calibri',color='w'))
